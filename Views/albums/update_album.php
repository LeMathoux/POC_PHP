...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center h-[80vh]">
        <div class="bg-white w-full max-w-lg rounded-2xl shadow-lg p-8">
            <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Modifier l'album</h1>
            ...
            <form action="" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" required
                        value="<?= htmlspecialchars($updatedAlbum->getTitle()) ?>"
                ...
                <div>
                    ...
                    <input type="text" id="author" name="author" required
                        value="<?= htmlspecialchars($updatedAlbum->getAuthor()) ?>"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>

                <div>
                    <label for="editor" class="block text-gray-700 font-medium mb-1">Éditeur</label>
                    <input type="text" id="editor" name="editor" required
                        value="<?= htmlspecialchars($updatedAlbum->getEditor()) ?>"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
